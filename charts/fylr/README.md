...
![Version: 1.1.225](https://img.shields.io/badge/Version-1.1.225-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v6.34.3](https://img.shields.io/badge/AppVersion-v6.34.3-informational?style=flat-square)
...
| https://programmfabrik.github.io/fylr-helm | execserver | 0.1.101 |
...
| fylr.services | object | `{"api":{"oauth2Server":{"allowHttpRedirects":true}},"webapp":{"basicAuth":{}}}` | defines settings for services that fylr should start. |
| fylr.services.api | object | `{"oauth2Server":{"allowHttpRedirects":true}}` | define settings for the api service |
| fylr.services.api.oauth2Server | object | `{"allowHttpRedirects":true}` | configures oauth2 related settings |
