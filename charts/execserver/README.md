...
![Version: 0.1.20](https://img.shields.io/badge/Version-0.1.20-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v6.6.2](https://img.shields.io/badge/AppVersion-v6.6.2-informational?style=flat-square)
...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"docker.fylr.io/fylr/fylr","tag":"v6.6.2"}` | The image to use for the execserver |
...
| image.tag | string | `"v6.6.2"` | The image tag Overrides the image tag whose default value is the appVersion of the chart. |
