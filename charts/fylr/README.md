...
![Version: 0.1.27](https://img.shields.io/badge/Version-0.1.27-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v6.5.0](https://img.shields.io/badge/AppVersion-v6.5.0-informational?style=flat-square)
...
| https://programmfabrik.github.io/fylr-helm | execserver | 0.1.15 |
...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"docker.fylr.io/fylr/fylr-server","tag":"v6.5.0"}` | The image to use for the container |
...
| image.tag | string | `"v6.5.0"` | Overrides the image tag whose default is the chart appVersion. |
