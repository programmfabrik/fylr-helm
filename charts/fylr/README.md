...
![Version: 0.1.40](https://img.shields.io/badge/Version-0.1.40-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v6.7.1](https://img.shields.io/badge/AppVersion-v6.7.1-informational?style=flat-square)
...
| https://programmfabrik.github.io/fylr-helm | execserver | 0.1.23 |
...
| image | object | `{"pullPolicy":"IfNotPresent","repository":"docker.fylr.io/fylr/fylr-server","tag":"v6.7.1"}` | The image to use for the container |
...
| image.tag | string | `"v6.7.1"` | Overrides the image tag whose default is the chart appVersion. |
